...
internal static class IGuildChatMessagesExtension {
    public static Dictionary<ulong, List<ChatMessageData>> SerializeChatMessages(this IChannelChatMessages guildChatMessages) {
    ...
    public static void DeserializeChatMessages(this IChannelChatMessages guildChatMessages, Dictionary<ulong, List<ChatMessageData>> chatMessages) {
